<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Basket.aspx.cs" Inherits="MEWeb.Account.Basket" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
                                ...
                                var Row = HomeContainerTab.Helpers.DivC("row margin0");
                                {
                                    var RowCol = Row.Helpers.DivC("col-md-6");
                                    {
                                        ...
                                        var BasketAmt = RowCol.Helpers.TableFor<MELib.Order.Order>((c) => c.OrderList, false, false);
                                        {
                                            ...
                                            //var FinalAmt = BasketAmtRow.AddColumn("Final Amount");
                                            //{
                                            //    //FinalAmt.Style.Width = "100px";
                                            //    var FinalAmText = BasketAmt.Helpers.EditorFor(c => c.Amount);
                                            //}
                                        ...
                                        }
                                        {
                                            ...
                                            var BasketAmtRow = BasketAmt.FirstRow;
                                            {
                                                ...
                                                //var CategoryID = BasketRow.AddColumn("Category");
                                                //{
                                                //    CategoryID.Style.Width = "100px";
                                                //    var CategoryIDText = CategoryID.Helpers.Span(c => c.BasketID);
                                                //}
                                                ...
                                                //var Delivery = BasketAmtRow.AddColumn(c => c.DeliveryOptionTypeID);
    ...
    <script type="text/javascript">
        ...
        var CheckOut = function (obj) {
            ViewModel.CallServerMethod('Checkout', { BasketID: obj.BasketID(), BasketList: ViewModel.BasketList.Serialise(), DeliveryOptionTypeID: obj.DeliveryOptionTypeID(), UserID: ViewModel.UserID(), ShowLoadingBar: true }, function (result) {
                if (result.Success) {
