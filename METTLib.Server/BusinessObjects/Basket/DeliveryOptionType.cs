// Generated 12 Nov 2021 13:51 - Singular Systems Object Generator Version 2.2.694
//<auto-generated/>
using System;
using Csla;
...
namespace MELib.Basket
{
    ...
    public class DeliveryOptionType
     : SingularBusinessBase<DeliveryOptionType>
    {
        #region " Properties and Methods "

        #region " Properties "

        public static PropertyInfo<int> DeliveryOptionTypeIDProperty = RegisterProperty<int>(c => c.DeliveryOptionTypeID, "ID", 0);
        /// <summary>
        /// Gets the ID value
        /// </summary>
        ...
        public static PropertyInfo<String> DeliveryOptionTypeProperty = RegisterProperty<String>(c => c.DeliveryOptionTypeName, "Delivery Option Type", "");
        /// <summary>
        /// Gets and sets the Delivery Option Type value
        /// </summary>
        [Display(Name = "Delivery Option Type", Description = ""),
        StringLength(50, ErrorMessage = "Delivery Option Type cannot be more than 50 characters")]
        public String DeliveryOptionTypeName
        {
            get { return GetProperty(DeliveryOptionTypeProperty); }
            set { SetProperty(DeliveryOptionTypeProperty, value); }
        }
        ...
        {
            return GetProperty(DeliveryOptionTypeIDProperty);
        }

        public override string ToString()
        {
            if (this.DeliveryOptionTypeName.Length == 0)
            {
                if (this.IsNew)
                {
                    return String.Format("New {0}", "Delivery Option Type");
                }
                else
                {
                    return String.Format("Blank {0}", "Delivery Option Type");
                }
            }
            else
            {
                return this.DeliveryOptionTypeName;
            }
        }
        ...
        protected override void OnCreate()
        {
            ...
            // Set any variables here, not in the constructor or NewDeliveryOptionType() method.
        }

        public static DeliveryOptionType NewDeliveryOptionType()
        {
            return DataPortal.CreateChild<DeliveryOptionType>();
        }
        ...
        internal static DeliveryOptionType GetDeliveryOptionType(SafeDataReader dr)
        {
            var d = new DeliveryOptionType();
            d.Fetch(dr);
            return d;
        }
        ...
        protected void Fetch(SafeDataReader sdr)
        {
            ...
            {
                int i = 0;
                LoadProperty(DeliveryOptionTypeIDProperty, sdr.GetInt32(i++));
                LoadProperty(DeliveryOptionTypeProperty, sdr.GetString(i++));
        ...
        protected override Action<SqlCommand> SetupSaveCommand(SqlCommand cm)
        {
            ...
            AddPrimaryKeyParam(cm, DeliveryOptionTypeIDProperty);

            cm.Parameters.AddWithValue("@DeliveryOptionType", GetProperty(DeliveryOptionTypeProperty));
    ...
    if (this.IsNew)
                {
                    LoadProperty(DeliveryOptionTypeIDProperty, scm.Parameters["@DeliveryOptionTypeID"].Value);
                }
            };
        }
